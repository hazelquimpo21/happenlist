-- ============================================================================
-- HAPPENLIST SCRAPER - DATABASE SCHEMA
-- ============================================================================
-- Run this SQL in your Supabase SQL Editor to set up the database.
--
-- IMPORTANT: You already have the main Happenlist schema set up.
-- This file contains the same schema for reference, plus an additional
-- table for tracking scraped events.
--
-- If you already have the tables from your existing Happenlist database,
-- you can skip to the "SCRAPER ADDITIONS" section at the bottom.
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS events (
  ...
  -- Scraper metadata (added for this tool)
  source_url TEXT,                    -- Where this was scraped from
...
-- IMPORTANT: These use SELECT only. The scraper uses the SERVICE KEY
-- which bypasses RLS, allowing it to INSERT/UPDATE.
...
-- ============================================================================
-- Initial category data. These should match what's in the scraper config!
...
-- 9. SCRAPER ADDITIONS
-- ============================================================================
-- Additional columns for tracking scraped events.
-- These might already exist from the main schema.
...
BEGIN
  IF NOT EXISTS (
    SELECT FROM information_schema.columns
    WHERE table_name = 'events' AND column_name = 'scraped_at'
  ) THEN
    ALTER TABLE events ADD COLUMN scraped_at TIMESTAMPTZ;
  END IF;
END $$;
...
-- DONE!
-- ============================================================================
-- Your database is ready for the Happenlist Scraper.
--
-- Next steps:
-- 1. Copy your Supabase URL and Service Key
-- 2. Add them to your backend .env file
-- 3. Deploy the backend to Render
-- 4. Configure the extension with your API URL
-- 5. Start scraping events!
-- ============================================================================
