  ...
  public: {
    Tables: {
      ...
      tag_cleanup_log: {
        ...
        Relationships: [
          {
            foreignKeyName: "tag_cleanup_log_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "events"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      record_event_view: {
        Args: { p_event_id: string; p_session_id: string; p_user_id?: string }
        Returns: boolean
      }
      search_venues: {
...
A new version of Supabase CLI is available: v2.90.0 (currently installed v2.70.5)
